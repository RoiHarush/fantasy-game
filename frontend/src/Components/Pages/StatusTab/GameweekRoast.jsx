        ...
        <section dir="rtl" className="relative overflow-hidden border-y border-brand-purple/20 py-5" aria-labelledby="gameweek-roast-title">
            ...
            <div className="flex flex-col gap-4 pr-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
                <div className="min-w-0">
                    ...
                    {available && !current && <>
                        <p className="text-base font-extrabold text-app-foreground sm:text-lg">אותו roast, לכל הליגה</p>
                        <p className="mt-1 max-w-2xl text-sm leading-relaxed text-app-muted">אחד החברים יכול לפתוח את הסבב; מאותו רגע כולם רואים את אותה הירידה שמתחלפת באותו זמן.</p>
                    </>}
